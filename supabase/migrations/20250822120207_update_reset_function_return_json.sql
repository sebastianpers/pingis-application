...
-- Byt ut ev. gammal version (RETURNS void) mot JSON-varianten
...
begin
  ...
  -- nollställ spelarstatistik enligt ditt schema
  ...
  -- (om finns) refresha materialiserad vy (OBS: ej CONCURRENTLY i funktion)
